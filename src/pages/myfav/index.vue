<template>
  <div class="container">
    ...
    <div class="quest_item" v-for="(item, itemIndex) in favlist" :key="item.id" @click="bindViewTap(item.category_name)" v-show="type=='fav'">
      <div class="wrap">
    ...
    <div class="quest_item" v-for="(item, itemIndex) in favlist" :key="item.id" @click="bindViewTap(item.id)" v-show="type=='recent'">
      <div class="wrap">
...
<style scoped>
  .title{font-size:30rpx;margin-left:20rpx;font-weight:bold;line-height:68rpx;color:#fff}
  .container{
